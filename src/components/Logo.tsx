  ...
  return (
    <div className={`flex items-center gap-2.5 sm:gap-3 select-none ${className}`}>
      ...
      <div className={`relative flex ${iconDimensions} shrink-0 items-center justify-center`}>
        {/* Ambient Glow */}
        <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-tr from-blue-600 to-emerald-400 opacity-30 blur-[6px] transition-all duration-300 group-hover:opacity-50" />
        ...
        <div className="relative flex h-full w-full items-center justify-center rounded-xl bg-gradient-to-b from-slate-900 via-blue-950 to-indigo-950 p-[1px] shadow-md shadow-blue-900/20 ring-1 ring-white/20">
          <div className="relative flex h-full w-full items-center justify-center rounded-[11px] bg-gradient-to-b from-blue-600 via-indigo-700 to-slate-900">
            {/* Glossy top overlay */}
            <div className="absolute inset-x-0 top-0 h-1/2 rounded-t-[11px] bg-gradient-to-b from-white/25 to-transparent" />
            
            {/* Custom Precision SVG Mark: Handcrafted iZone Shield + GPS Radar Crosshair */}
            <svg
              viewBox="0 0 36 36"
              fill="none"
            ...
            >
              ...
              {/* Inner Safe Satellite Radar Ring */}
              <circle
                cx="18"
                cy="17"
                r="6.5"
              ...
              {/* Glowing Safe Location Pulse Core */}
              <circle cx="18" cy="17" r="3.25" fill="url(#coreGrad)" />
              <circle cx="18" cy="17" r="1.25" fill="#FFFFFF" />

              {/* Active Signal Wave Accent Dot */}
              <circle cx="26" cy="7.5" r="2" fill="#10B981" />
              <circle cx="26" cy="7.5" r="3.5" fill="none" stroke="#34D399" strokeWidth="1" className="animate-ping opacity-75" />
            </svg>
          </div>
        </div>
      </div>

      {/* Handcrafted iZone Typography & Branding */}
      <div className="flex flex-col justify-center leading-none">
        <div className="flex items-center gap-1">
          <span className={`${titleSize} font-extrabold tracking-tight text-slate-900`}>
            ...
            <span className="text-slate-900 font-extrabold">Zone</span>
          </span>

          <span className="inline-flex items-center rounded-md bg-emerald-50 px-1.5 py-0.5 text-[9px] sm:text-[10px] font-bold tracking-wider text-emerald-700 uppercase border border-emerald-200/70 shadow-[0_1px_2px_rgba(16,185,129,0.08)]">
            SAFE GPS
          </span>
        </div>
